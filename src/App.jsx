...
import { Search, ShoppingCart, User, Menu, Zap, Truck, Shield, Code, Star, Download, Eye } from 'lucide-react'
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-2xl font-bold text-primary">SistemasOnline</h1>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold mb-6">
                Soluções Digitais <span className="text-accent">Completas</span> para o Seu Negócio
              </h1>
              <p className="text-xl mb-8 text-primary-foreground/90">
                Sistemas, aplicativos e scripts profissionais para impulsionar sua empresa. 
                Código fonte incluído, suporte técnico e entrega imediata.
              </p>
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-white text-lg font-semibold mb-4">SistemasOnline</h3>
              <p className="text-sm">
                Sua loja de confiança para sistemas e softwares profissionais. 
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
            <p>&copy; 2024 SistemasOnline. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
